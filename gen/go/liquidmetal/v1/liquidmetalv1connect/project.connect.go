...
const (
	...
	ProjectServiceName = "liquidmetal.v1.ProjectService"
)
...
const (
	...
	// CreateProject RPC.
	ProjectServiceCreateProjectProcedure = "/liquidmetal.v1.ProjectService/CreateProject"
	// ProjectServiceListProjectsProcedure is the fully-qualified name of the ProjectService's
	// ListProjects RPC.
	ProjectServiceListProjectsProcedure = "/liquidmetal.v1.ProjectService/ListProjects"
)

// ProjectServiceClient is a client for the liquidmetal.v1.ProjectService service.
type ProjectServiceClient interface {
	CreateProject(context.Context, *connect.Request[v1.CreateProjectRequest]) (*connect.Response[v1.CreateProjectResponse], error)
	ListProjects(context.Context, *connect.Request[v1.ListProjectsRequest]) (*connect.Response[v1.ListProjectsResponse], error)
}

// NewProjectServiceClient constructs a client for the liquidmetal.v1.ProjectService service. By
...
func NewProjectServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ProjectServiceClient {
	...
	projectServiceMethods := v1.File_liquidmetal_v1_project_proto.Services().ByName("ProjectService").Methods()
...
// CreateProject calls liquidmetal.v1.ProjectService.CreateProject.
...
// ListProjects calls liquidmetal.v1.ProjectService.ListProjects.
...
// ProjectServiceHandler is an implementation of the liquidmetal.v1.ProjectService service.
...
func NewProjectServiceHandler(svc ProjectServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/liquidmetal.v1.ProjectService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedProjectServiceHandler) CreateProject(context.Context, *connect.Request[v1.CreateProjectRequest]) (*connect.Response[v1.CreateProjectResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("liquidmetal.v1.ProjectService.CreateProject is not implemented"))
}
...
func (UnimplementedProjectServiceHandler) ListProjects(context.Context, *connect.Request[v1.ListProjectsRequest]) (*connect.Response[v1.ListProjectsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("liquidmetal.v1.ProjectService.ListProjects is not implemented"))
}

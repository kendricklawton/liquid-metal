...
const (
	...
	UserServiceName = "liquidmetal.v1.UserService"
)
...
const (
	...
	UserServiceGetMeProcedure = "/liquidmetal.v1.UserService/GetMe"
)
...
// NewUserServiceClient constructs a client for the liquidmetal.v1.UserService service. By default,
...
func NewUserServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UserServiceClient {
	...
	userServiceMethods := v1.File_liquidmetal_v1_user_proto.Services().ByName("UserService").Methods()
...
// GetMe calls liquidmetal.v1.UserService.GetMe.
...
func NewUserServiceHandler(svc UserServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/liquidmetal.v1.UserService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedUserServiceHandler) GetMe(context.Context, *connect.Request[v1.GetMeRequest]) (*connect.Response[v1.GetMeResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("liquidmetal.v1.UserService.GetMe is not implemented"))
}
